...
if (${BUILD_GROUP} STREQUAL "game")
	...
	if (${BUILD_GAME} STREQUAL "tf2vintage")
		include("${SRCDIR}/game/client/client_tf2vintage.cmake")
		include("${SRCDIR}/game/server/server_tf2vintage.cmake")
	endif()
...
elseif (${BUILD_GROUP} STREQUAL "everything")
	...
	if (${BUILD_GAME} STREQUAL "tf2vintage")
		include("${SRCDIR}/game/client/client_tf2vintage.cmake")
		include("${SRCDIR}/game/server/server_tf2vintage.cmake")
		include("${SRCDIR}/materialsystem/stdshaders/game_shader_dx9_tf2vintage.cmake")
	endif()
